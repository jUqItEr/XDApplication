...
public class ProfilePanel extends JPanel implements LocaleChangeListener {
    ...
    private void initialize() {
        ...
        JPanel userInfoMainPane = new JPanel();
        ...
        userInfoMainPane.setLayout(new BorderLayout());
        ...
        //userInfoMainPane.setBorder(BorderFactory.createEmptyBorder(15, 20, 15, 20));
        ...
        userInfoMainPane.add(userInfoPane, BorderLayout.WEST);

        JComponent tmpButton;

        userInfoMainPane.setBackground(Color.PINK);
        ...
        userInfoMainPane.add(tmpButton, BorderLayout.EAST);
